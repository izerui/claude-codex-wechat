...
export function createDefaultProviders(input: {
  ...
  return [
    ...
    new CodexProvider({ runner: new CodexInteractiveRunner({ command: input.codexCommand, mcpServerConfigs: input.codexMcpServerConfigs }) }),
  ];
}
